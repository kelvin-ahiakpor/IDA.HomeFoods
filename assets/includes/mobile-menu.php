    ...
    <div class="bg-white w-64 h-full transform transition-transform duration-300 -translate-x-full" id="mobileMenuContent">
        ...
        <nav class="p-4">
            <ul class="space-y-2">
                ...
                <li> <a href="./manage_consultants.php" class="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-100"> <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                        </svg> <span>Consultants</span> </a> </li>
                <li> <a href="./manage_clients.php" class="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-100"> <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
